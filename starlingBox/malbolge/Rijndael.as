...
{ 
	...
	* 
	* remplacer les array par des vector ?
	* 
	*/
	...
	public class Rijndael {
		...
		*/
		...
		public var keySize:Number;
	
		/**
		* Constructor
		* @exclude
		*/
		public function Rijndael(keySize:Number = 128, blockSize:Number = 128) {			
		...
		*/
		...
		protected function byteSub(state:Array, dir:String):void {
			...
			for (var i:Number = 0; i<4; i++) {
				for (var j:int = 0; j<this.Nb; j++) state[i][j] = S[state[i][j]];
			}
		}
